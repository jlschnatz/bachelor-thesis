...
## Appendix F: Supplementary Material of Exploratory Analyses


```{=latex}
\begin{figure}[h]
\caption{Pairs Plots of Discussed Correlations from Exploratory Diagnostic Analysis}
\label{fig:pairs}
```
```{r pairs}
#| out-width: 100%
#| fig-align: center
knitr::include_graphics(here("figures/pairs.png"))
```
