...
1. What is the extent of discrepancy between SPEEC and MLE in the estimation of the distributional parameters?
2. How consistent is the discprenancy between SPEEC and MLE across the four distributional parameters?
3. Is the discprenancy between SPEEC and MLE in the distributional parameters associated with sample size of multisize replication studies *k* (number of replications)?
4. Is the discprenancy between SPEEC and MLE in the distributional parameters associated with the publication bias parameter?
