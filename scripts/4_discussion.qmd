...
In summary, the challenges faced by the current version of the SPEEC method, that are likely to attributable to between-study heterogeneity, align with other statistical methods that assume a fixed-effects meta-analytical model, like *p*-uniform [@van_assen_meta-analysis_2015] and *p*-curve analysis [@simonsohn_p-curve_2014], which tend to perform poorly in the presence of high heterogeneity [@mcshane_adjusting_2016].

overestimation of the true effect size under high heterogeneity [@mcshane_adjusting_2016; @carter_correcting_2019; @van_aert_conducting_2016]
