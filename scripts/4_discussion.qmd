...
In this regard, no evidence was found, that uncertainty related to the sample size $k$ of the RRRs was associated with the misestimation of the distributional parameters of SPEEC from MLE. However, strong positive correlations were found between the misestimation of SPEEC from MLE in the effect size distribution parameters $|\Delta_{\widehat{\mu}_d}|$, $|\Delta_{\widehat{\sigma}^2_d}|$) and between-study heterogeneity $\widehat{\tau}$, Additionaly, medium negative correlation between publication bias parameter $\epbs$ and and between-study heterogeneity $\widehat{\tau}$.

As I will argue below, this may be a plausible cause of the parameter misestimation.
