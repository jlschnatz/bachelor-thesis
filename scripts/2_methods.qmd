...
To analyse the confirmatory hypotheses of this study, assessement of the SPEEC method,
...
#| echo: false
#| message: false
#| tbl-cap: Smallest Effect Sizes of Interest of the Hypotheses
#| label: tbl-sesoi
...
general <- "\\\\noindent \\\\textit{Note.}  Except for $\\\\mathcal{H}_3$ all SESOIs are defined in terms of odds ratios (OR). The SESOI of $\\\\mathcal{H}_3$ is defined in raw units."
...
kable(
  ...
  threeparttable = TRUE,
  booktabs = TRUE,
  col.names = c("Hypothesis", "SESOI", "Unit"),
  escape = FALSE,
  align = "lcc"
  ) |>
  ...
  footnote(
    ...
    column_spec(column = 2:3, width = "6cm")
