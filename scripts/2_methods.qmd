...
The confirmatory statistical analyses were preregistered based on an adaption of the secondary data analysis preregistration template by @van_den_akker_preregistration_2021. The preregistration includes additional metadata of the dataset and a transparency statement regarding prior data knowledge.  Any supplementary analyses not preregistered and deviations of the preregistered confirmatory analyses are explicitly labelled as such. All data, analysis scripts and the preregistration are made available (see section [Appendix A: Research Transparency Statement](Appendix A: Research Transparency Statement)). All confirmatory analyses were performed using the R programming language [version `r r_ver`, @r_core_team_r_2023] in the VSCode IDE [version 1.89.1, @microsoft_corporation_visual_2024].
