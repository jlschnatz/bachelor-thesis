...
To analyse the confirmatory hypotheses of this study which aims to give a broad assessment about the viability of the SPEEC method, we use secondary data from previus work by @linden_heterogeneity_2021.

This extensive dataset containing both traditional meta-analyses  and large scale replication studies
