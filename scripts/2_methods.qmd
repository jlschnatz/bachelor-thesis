...
\noindent
With this normalization factor, the total variance of the individual variances of the individual variances is $\mathbb{E}(\gamma_i \cdot \sigma^2_d) = \sigma^2_d$. The study-specific effect sizes $d_i$ are subsequently modelled as
