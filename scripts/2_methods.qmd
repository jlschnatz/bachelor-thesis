...
$$
\begin{aligned}
& \min_{\mu_d,  ~ \sigma^2_d,  ~ \mu_n, ~ \phi_n, ~ \omega_{PBS}} \Big\{D_{\text{KL}}(\widehat{f}_e ~ \| ~ \widehat{f}_t) \Big\}, \quad \text{subject to:} ~ \mu_d, ~ \sigma^2_d, ~ \mu_n, ~ \phi_n,~ \omega_{PBS} \in \mathbb{R} \\
& -4 \leq \mu_d \leq 4, \quad 0 \leq \sigma^2_d \leq 6, \\
& 10 \leq \mu_n \leq 15000, \quad 0.01 \leq \phi_n \leq 1000, 0 \leq \omega_{PBS} \leq 1
\end{aligned}
$$ {eq-optim}
