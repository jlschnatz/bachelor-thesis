...
\end{tabular}
\begin{tablenotes}
\item \noindent \textit{Note.} Computed $p$-values are corrected for multiple comparison using the correction by Benjamini \& Hochberg (1995). $\lvert\Delta\rvert$ is the absolute difference for each distributional parameter between SPEEC and MLE.
